...
export const ACHIEVEMENTS_CATALOG: Achievement[] = [
    ...
    { id: "soc_7", titulo: "Influencer II", desc: "Recebeu 100 curtidas em seus posts.", cat: "Social", xp: 1000, target: 100, statKey: "likesReceived", iconName: "Heart" },
    ...
    { id: "gym_4", titulo: "Monstro da Jaula", desc: "Confirmou presença em 150 treinos.", cat: "Gym", xp: 7000, target: 150, statKey: "gymCheckins", iconName: "Trophy" },
    ...
    { id: "gym_6", titulo: "Foco Total", desc: "Manteve 10 dias seguidos de treino.", cat: "Gym", xp: 1500, target: 10, statKey: "gymStreak", iconName: "Flame" },
    { id: "gym_7", titulo: "Shape Inexplicável", desc: "Alcançou o nível máximo de treinos no semestre.", cat: "Gym", xp: 5000, target: 80, statKey: "gymSemestre", iconName: "Star" },
    ...
    { id: "game_6", titulo: "Saco de Pancada", desc: "Perdeu 5 partidas seguidas.", cat: "Games", xp: 50, target: 5, statKey: "arenaLoseStreak", iconName: "Ghost" },
    { id: "game_7", titulo: "MVP AAAKN", desc: "Ganhou um torneio oficial da Arena.", cat: "Games", xp: 5000, target: 1, statKey: "arenaTournaments", iconName: "Medal" },

    // --- LOJA & ECONOMIA (6 Itens) ---
    { id: "shop_1", titulo: "Apoiador", desc: "Realizou sua primeira compra na loja.", cat: "Loja", xp: 100, target: 1, statKey: "storeOrders", iconName: "ShoppingBag" },
    { id: "shop_2", titulo: "Investidor I", desc: "Gastou R$ 200,00 totais na loja.", cat: "Loja", xp: 500, target: 200, statKey: "storeSpent", iconName: "DollarSign" },
    { id: "shop_3", titulo: "Investidor II", desc: "Gastou R$ 1.000,00 totais na loja.", cat: "Loja", xp: 2000, target: 1000, statKey: "storeSpent", iconName: "Wallet" },
    { id: "shop_4", titulo: "Baleia Branca", desc: "Gastou R$ 5.000,00 totais na loja.", cat: "Loja", xp: 15000, target: 5000, statKey: "storeSpent", iconName: "Gem" },
    ...
    { id: "shop_6", titulo: "Sócio Elite", desc: "Assinou o plano anual.", cat: "Loja", xp: 5000, target: 1, statKey: "planAnual", iconName: "Crown" },
    ...
    { id: "evt_2", titulo: "Inimigo do Fim", desc: "Fez check-in em 5 eventos oficiais.", cat: "Eventos", xp: 800, target: 5, statKey: "eventsAttended", iconName: "Beer" },
    ...
    { id: "evt_4", titulo: "Comissário", desc: "Vendeu 10 ingressos via código.", cat: "Eventos", xp: 2000, target: 10, statKey: "ticketsSold", iconName: "Target" },
    { id: "evt_5", titulo: "VIP", desc: "Comprou 3 ingressos de Lote Promocional.", cat: "Eventos", xp: 500, target: 3, statKey: "eventsPromo", iconName: "PartyPopper" },
    { id: "evt_6", titulo: "Nerd da Turma", desc: "Participou de 2 eventos acadêmicos.", cat: "Eventos", xp: 400, target: 2, statKey: "eventsAcademic", iconName: "BookOpen" },
    { id: "evt_7", titulo: "Coração de Ouro", desc: "Participou de uma ação social da Atlética.", cat: "Eventos", xp: 2000, target: 1, statKey: "solidarityCount", iconName: "HeartHandshake" }
];